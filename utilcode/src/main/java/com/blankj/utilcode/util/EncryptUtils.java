...
public final class EncryptUtils {
    ...
    public static String encryptMD2ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptMD2(data),true);
    }
     ...
     * @return the hex string of MD5 encryption
     */
    public static String encryptMD5ToString(final String data,boolean isUpperCase) {
        if (data == null || data.length() == 0) return "";
        return encryptMD5ToString(data.getBytes(),isUpperCase);
    }
    ...
    public static String encryptMD5ToString(final String data, final String salt) {
        ...
        if (salt == null) return UtilsBridge.bytes2HexString(encryptMD5(data.getBytes()),true);
        if (data == null) return UtilsBridge.bytes2HexString(encryptMD5(salt.getBytes()),true);
        return UtilsBridge.bytes2HexString(encryptMD5((data + salt).getBytes()),true);
    }
     ...
     * @return the hex string of MD5 encryption
     */
    public static String encryptMD5ToString(final byte[] data, boolean isUpperCase) {
        return UtilsBridge.bytes2HexString(encryptMD5(data),isUpperCase);
    }
    ...
    public static String encryptMD5ToString(final byte[] data, final byte[] salt) {
        if (data == null && salt == null) return "";
        if (salt == null) return UtilsBridge.bytes2HexString(encryptMD5(data),true);
        if (data == null) return UtilsBridge.bytes2HexString(encryptMD5(salt),true);
        byte[] dataSalt = new byte[data.length + salt.length];
        System.arraycopy(data, 0, dataSalt, 0, data.length);
        System.arraycopy(salt, 0, dataSalt, data.length, salt.length);
        return UtilsBridge.bytes2HexString(encryptMD5(dataSalt),true);
    }
    ...
    public static String encryptMD5File2String(final File file) {
        return UtilsBridge.bytes2HexString(encryptMD5File(file),true);
    }
    ...
    public static String encryptSHA1ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptSHA1(data),true);
    }
    ...
    public static String encryptSHA224ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptSHA224(data),true);
    }
    ...
    public static String encryptSHA256ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptSHA256(data),true);
    }
    ...
    public static String encryptSHA384ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptSHA384(data),true);
    }
    ...
    public static String encryptSHA512ToString(final byte[] data) {
        return UtilsBridge.bytes2HexString(encryptSHA512(data),true);
    }
    ...
    public static String encryptHmacMD5ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacMD5(data, key),true);
    }
    ...
    public static String encryptHmacSHA1ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacSHA1(data, key),true);
    }
    ...
    public static String encryptHmacSHA224ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacSHA224(data, key),true);
    }
    ...
    public static String encryptHmacSHA256ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacSHA256(data, key),true);
    }
    ...
    public static String encryptHmacSHA384ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacSHA384(data, key),true);
    }
    ...
    public static String encryptHmacSHA512ToString(final byte[] data, final byte[] key) {
        return UtilsBridge.bytes2HexString(encryptHmacSHA512(data, key),true);
    }
    ...
    public static String encryptDES2HexString(final byte[] data,
                                              ...
                                              final String transformation,
                                              final byte[] iv) {
        return UtilsBridge.bytes2HexString(encryptDES(data, key, transformation, iv),true);
    }
    ...
    public static String encrypt3DES2HexString(final byte[] data,
                                               ...
                                               final String transformation,
                                               final byte[] iv) {
        return UtilsBridge.bytes2HexString(encrypt3DES(data, key, transformation, iv),true);
    }
    ...
    public static String encryptAES2HexString(final byte[] data,
                                              ...
                                              final String transformation,
                                              final byte[] iv) {
        return UtilsBridge.bytes2HexString(encryptAES(data, key, transformation, iv),true);
    }
    ...
    public static String encryptRSA2HexString(final byte[] data,
                                              ...
                                              final int keySize,
                                              final String transformation) {
        return UtilsBridge.bytes2HexString(encryptRSA(data, publicKey, keySize, transformation),true);
    }
