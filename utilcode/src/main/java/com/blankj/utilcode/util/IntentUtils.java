...
public final class IntentUtils {
    ...
    public static Intent getShareTextIntent(final String content,final boolean isNewTask) {
        return getShareTextIntent(content,null,isNewTask);
    }
     ...
     * @return the intent of share text
     */
    public static Intent getShareTextIntent(final String content,String packageName,final boolean isNewTask) {
     ...
     * @return the intent of share image
     */
    public static Intent getShareImageIntent(final String imagePath,final boolean isNewTask) {
        return getShareTextImageIntent("", imagePath,isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareImageIntent(final File imageFile,final boolean isNewTask) {
        return getShareTextImageIntent("", imageFile,null,isNewTask);
    }

    public static Intent getShareImageIntent(final File imageFile,String packageName,final boolean isNewTask) {
        return getShareTextImageIntent("", imageFile,packageName,isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareImageIntent(final Uri imageUri,final boolean isNewTask) {
        return getShareTextImageIntent("", imageUri,null,isNewTask);
    }

    public static Intent getShareImageIntent(final Uri imageUri,String packageName,final boolean isNewTask) {
        return getShareTextImageIntent("", imageUri,packageName,isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareTextImageIntent(@Nullable final String content, final String imagePath,final boolean isNewTask) {
        return getShareTextImageIntent(content, UtilsBridge.getFileByPath(imagePath),null,isNewTask);
    }

    public static Intent getShareTextImageIntent(@Nullable final String content, final String imagePath,String packageName,final boolean isNewTask) {
        return getShareTextImageIntent(content, UtilsBridge.getFileByPath(imagePath),packageName,isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareTextImageIntent(@Nullable final String content, final File imageFile,String packageName,final boolean isNewTask) {
        return getShareTextImageIntent(content, UtilsBridge.file2Uri(imageFile),packageName,isNewTask);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareTextImageIntent(@Nullable final String content, final Uri imageUri,String packageName,
