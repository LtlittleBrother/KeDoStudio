...
public class CameraDrawer {
    ...
    public static final byte VERTEX_ORDER[] = {0, 1, 2, 3}; // order to draw vertices
...
//        mTextureHandle = 1;
        ...
        mTextureHandle = GLES20.glGetAttribLocation(mProgram, "vInputTextureCoordinate");
    }

    public void draw(int texture, boolean isFrontCamera) {
        java.nio.IntBuffer lastProgram =  java.nio.IntBuffer.allocate(1);
        GLES20.glGetIntegerv(GLES20.GL_CURRENT_PROGRAM, lastProgram);
...
//        GLES20.glDisableVertexAttribArray(mTextureHandle);
        int lp = lastProgram.get();
        GLES20.glUseProgram(lp);
    }
